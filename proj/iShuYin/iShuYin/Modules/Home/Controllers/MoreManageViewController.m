...
@interface MoreManageViewController ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource>
...
- (void)configUI {
    self.navigationItem.titleView = [UILabel navigationItemTitleViewWithText:@"榜单"];
...
- (void)configPageVC {
    ...
    [self.pageVC setViewControllers:@[_vcArray[_index]]
...
- (HMSegmentedControl *)seg {
    if (!_seg) {
        ...
        _seg.sectionTitles = @[@"推荐",@"热播",@"最新"];
        _seg.selectedSegmentIndex = _index;
